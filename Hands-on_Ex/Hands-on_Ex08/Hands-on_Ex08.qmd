...
The entire dataset is split into training and test data sets with a 65% and 35% component respectively by using *initial_split()* of **rsample** package. rsample is one of the packages of [tidymodels](https://www.tidymodels.org/).
...
The code chunk below is used to save the training and test data into rds format for ease of retrival.
